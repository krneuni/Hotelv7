...
namespace VLO.Controllers
{
    public class FacturasController : Controller
    {
        ...
        {
            var factura = db.Factura.Include(f => f.DetallePedido);
        ...
        //[HttpPost]
        //public ActionResult Factura(int idDetalle)
        //{
        //    var orden = db.Factura.Where(x => x.IdDetalle == idDetalle).ToList();
        //    return View(orden);
        //}
        ...
        public ActionResult Create([Bind(Include = "NumFactura,IdDetalle,Precio,Descuento,FechaFactura, Descripcion, Propina")] Factura factura)
        {
            ...
            ViewBag.IdDetalle = new SelectList(db.DetallePedido, "IdDetalle", "IdDetalle", factura.IdDetalle);
            return View(factura);
        }
